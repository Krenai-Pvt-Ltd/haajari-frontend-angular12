...
export declare class DaterangepickerComponent implements OnInit, OnChanges {
    ...
    isCustomDate(date: dayjs.Dayjs): boolean;
    isTooltipDate(date: dayjs.Dayjs): string | boolean | null;
    ...
    setStartDate(startDate: string | dayjs.Dayjs): void;
    setEndDate(endDate: string | dayjs.Dayjs): void;
    updateView(): void;
