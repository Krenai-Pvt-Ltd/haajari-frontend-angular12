export class Routes {
 ...
 /**
    ...
    */
    ...
    public static PAYROLLMANAGEMENTS = "/payroll/payroll-managements"
    public static EMPLOYEECHANGES = "/payroll/employee-changes"
    public static ATTENDANCELOPMANAGEMENT = "/payroll/attendance-lop-management"
